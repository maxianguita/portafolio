...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_y6cxuoo', 'template_nkxmi7d', form.current,'Yo24jTOebF4w6IZKH')
         .then((result) => {
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div">
                        ...
                        <input type="email" name='email' className='contact__form-input' placeholder='Escribe tu Correo'/>
                    </div>

                    <div className="contact__form-div contact__form-area">
                        <label htmlFor="" className="contact__form-tag">Proyecto</label>
                        <textarea name="project" cols="30" rows="10" className='contact__form-input' placeholder='Escríbeme sobre tu Proyecto'></textarea>
                    </div>
